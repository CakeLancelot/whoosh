...
from PySide6.QtWidgets import (
    ...
    QFileDialog, QTreeView, QHeaderView, QToolBar, QSizePolicy,
)
...
class AudioPlayerWidget(QWidget):
    def __init__(self, obj: ObjectInfo, parent=None):
        ...
        temp_file = _write_temp_file(self.unity_object.contents.audio_data)
...
class MoviePlayerWidget(QWidget):
    def __init__(self, obj: ObjectInfo, parent=None):
        ...
        temp_file = _write_temp_file(self.unity_object.contents.movie_data)
